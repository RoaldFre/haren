...
main = do
    ...
    gen <- getStdGen
    renderPPM 100 outfile (mkScene optimMesh) $ mkConf gen
...
mkScene anyGeom = scene
    where
        ...
        key   = Light (mkSoftBox (F3 (12) 0.2 8) (F3 (3) 0 (0)) (F3 0 7 0) f3zero n) (9 *. white)
        fillbg = Light (mkSoftBox (F3 (-10) 5 (-2)) (F3 (20) 0 (0)) (F3 0 6 (-1)) (F3 0 0 (-100)) n) (30 *. white)
        fillfg = Light (mkSoftBox (F3 (-10) 0.2 (10)) (F3 (20) 0 (0)) (F3 0 1 (-0.1)) (F3 0 0 (-100)) n) (3 *. white)
        strip = Light (mkSoftBox (F3 (-2.5) 0.2 5) (F3 (0.1) 0 (0.1)) (F3 0 2 0) f3zero n) (0.35 *. white)
        riml  = Light (mkSoftBox (F3 (-21) 0.4 (-16)) (F3 0 1 0) (F3 4 0 (0)) f3zero n) (80 *. white)
        rimr  = Light (mkSoftBox (F3 (20) 0.5 (-12)) (F3 0 1 0) (F3 (-3) 0 (-2)) f3zero n) (40 *. white)

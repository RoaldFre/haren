...
type Point = Flt3
type Vector = Flt3
type UnitVector = Flt3

data Flt3 = Flt3 !Flt !Flt !Flt -- only used for generic functions below
...
infixl 6 .+. 
(.+.) :: Flt3 -> Flt3 -> Flt3
(Flt3 x1 y1 z1) .+. (Flt3 x2 y2 z2) = Flt3 (x1 + x2) (y1 + y2) (z1 + z2) 
...
infixl 7 .*.
(.*.) :: Flt3 -> Flt3 -> Flt
(Flt3 x1 y1 z1) .*. (Flt3 x2 y2 z2) = x1*x2 + y1*y2 + z1*z2 
...
(.^.) :: Flt3 -> Flt3 -> Flt3
(Flt3 x1 y1 z1) .^. (Flt3 x2 y2 z2) = Flt3
                                        (y1 * z2  -  z1 * y2)
                                        (z1 * x2  -  x1 * z2)
                                        (x1 * y2  -  y1 * x2)
